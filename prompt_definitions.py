...
写作风格要求：
- 文笔细腻，注重细节描绘，能够营造强烈的画面感和氛围。
- 叙事节奏张弛有度，既有紧张刺激的情节推进，也有舒缓的人物内心刻画。
- 语言精炼，避免冗余和口水话，力求用最准确的词语表达最丰富的内容。
- 情感表达真挚自然，能够引起读者共鸣。
- 在保持整体风格统一的前提下，可以根据不同场景和角色情绪适当调整语气和节奏。
- 多使用感官描写，让读者能够身临其境。
- 避免使用过于生僻或网络化的词汇，保持文本的经典和耐读性。
"""
